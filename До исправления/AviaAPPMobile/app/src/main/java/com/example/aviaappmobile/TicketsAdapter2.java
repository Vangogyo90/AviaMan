...
public class TicketsAdapter2 extends RecyclerView.Adapter<TicketsAdapter2.ViewHolder> {
    private final LayoutInflater inflater;
    private final List<AirTicket> airTickets;

    TicketsAdapter2(Context context, List<AirTicket> airTickets){
    ...
    @Override
    @NotNull
    public TicketsAdapter2.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType){
        View view = inflater.inflate(R.layout.item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(TicketsAdapter2.ViewHolder holder, int position) {
        ...
        ViewHolder(View view){
            ...
            more.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    BuyingTicketsActivity.pos = position;
                    BuyingTicketsActivity.MoreBut();
                }
            });
        }
    }
